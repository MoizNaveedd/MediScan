...
import { getScanCount } from '../utils/scanTracker';
    ...
    >
      <div className="max-w-4xl mx-auto">
        ...
        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="font-semibold text-gray-700 font-mono">{serialNumber}</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-2">
                        <Scan className="w-5 h-5 text-blue-500" />
                        <div>
                          <p className="text-xs text-gray-400">Times Scanned</p>
          ...
          <motion.div 
            variants={itemVariants}
            className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-6 mb-6 border-2 border-green-200 shadow-lg relative overflow-hidden"
          >
            ...
            <div className="relative flex items-start gap-4">
              <div className="flex-shrink-0 p-3 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl shadow-lg">
                <Shield className="w-6 h-6 text-white" />
              </div>
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-2">
                  <h3 className="text-lg font-bold text-green-800">Authenticity Verification</h3>
                  {drug.authenticityVerified && (
                    <motion.div
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                ...
                <p className="text-green-800 leading-relaxed font-medium">{drug.authenticityNote}</p>
              </div>
            </div>
          </motion.div>
